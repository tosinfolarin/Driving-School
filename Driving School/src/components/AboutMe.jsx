const AboutMe = () => {
    ...
    <img src = 'https://placehold.co/600x300' alt='instructors picture' className="instructor-image" />
    </div>
    
    <div className="flex-c aboutme">
      ...
      <br></br>I understand that as a learner, it is very rare for you to have perfect knowledge of driving. With Trinity, no question is a silly question
