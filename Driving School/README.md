...
This web application also offers users the ability to see other available driving schools in the area of their choice. 
Origianlly, this had been created using a Yelp API and was implemented with the help of this youtube tutorial:
